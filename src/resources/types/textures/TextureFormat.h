...
namespace engine::resources {
    ...
    namespace TextureFormatUtils {
        ...
        std::uint32_t getBytesPerPixel(TextureFormat format);
        ...
        std::uint32_t getBlockSize(TextureFormat format);
        ...
        // Calculate size for mip level
        void getMipDimensions(std::uint32_t mipLevel, std::uint32_t baseWidth,
