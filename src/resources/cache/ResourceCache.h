...
namespace engine::resources {
    ...
    public:
        ...
        void insert(ResourceID id, ResourcePtr<T> resource) {
            ...
            // Add to front
            lruList_.push_front({resource, std::chrono::steady_clock::now(), 0, resource->getMemoryUsage()});
        ...
        // Set cache limits
        void setMaxMemory(ResourceSize requestedMaxMemory) { maxMemory_ = requestedMaxMemory; }
        void setMaxCount(std::size_t requestedMaxCount) { maxCount_ = requestedMaxCount; }
